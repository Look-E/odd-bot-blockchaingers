...
def set_df(df, settings, metrics, db):
    ...
    #        if ix!=neighbour_ix:
        ...
        fr = df.loc[selection]
        df.loc[selection,'u'] = reward *fr.ds.clip_upper(speed) * fr['dx']/fr['ds']
        df.loc[selection,'v'] = reward *fr.ds.clip_upper(speed) * fr['dy']/fr['ds']
    
        df.loc[selection,'u1'] = penalty *fr.ds1.clip_upper(speed) * fr['dx1']/fr['ds1']
        df.loc[selection,'v1'] = penalty *fr.ds1.clip_upper(speed) * fr['dy1']/fr['ds1']
